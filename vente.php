...
if(isset($_POST['addvente'])){
    ...
    $sql=" INSERT INTO `vente`( `refclient`,`refproduit`,`quantite`,`prix_u`,`date_vente`) VALUES ('$refclient','$refproduit','$quantite','$prix_u','$date_vente')";
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="modal fade" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="demoModalLabel">vente add</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form  method="post">
                                            <div class="mb-3">
                                                <label for="field-3" class="form-label">client</label>
                                                <?php
                                                ...
                                                <select name="refproduit" id="" class="form-control">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                    <option value="<?php echo $row["id"];?>"> <?php echo $row["nomProd"];?> </option>
                                                    <?php
                                                        } 
                                                    ?>
                                                </select>
                                                <label for="field-3" class="form-label">quantite</label>
                                                <input type="text" name="quantite" class="form-control" id="field-3" placeholder=" enter your quantity">
                                                <label for="field-3" class="form-label">prix_u</label>
                                                <input type="text" name="prix_u" class="form-control" id="field-3" placeholder=" enter your prix_u">
                                                <label for="field-3" class="form-label">date de la vente</label>
                                                <input type="date" name="date_vente" class="form-control">

                                       </div>
                                        <button type="submit" class="btn btn-primary" name="addvente">Save</button>
                                        </form>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add vente</button><br>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button  class="btn btn-primary"> <a href="edit-vente.php? updateid=' . $id . '" class="text-light">edit</a> </button>
                                                        <button class="btn btn-danger"name="danger">   <a href="delete-vente.php? deletedid=' . $id . '" class="text-light">delete</a> </button>
                                                        </td>
                                                        </tr>';
                                                    }
                                                }
