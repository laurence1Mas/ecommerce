...
if(isset($_POST['addclient'])){
    ...
    $sql=" INSERT INTO `utilisateur`( `nom`,`adresse`,`email`,`PASSWORDS`,`telephone`) VALUES ('$nom','$adresse','$email','".md5($_POST['PASSWORDS'])."','$telephone')";
                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="modal fade" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="demoModalLabel">User add</h5>
                                    ...
                                    <div class="modal-body">
                                        <form  method="post">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="adresse" class="form-control" id="field-3" placeholder=" enter your phone adress">
                                                ...
                                                <label for="field-3" class="form-label">Mot de passe</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add client</button><br>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button  class="btn btn-primary"> <a href="edit-client.php? updateid=' . $id . '" class="text-light">edit</a> </button>
                                                        <button class="btn btn-danger"name="danger">   <a href="delete-client.php? deletedid=' . $id . '" class="text-light">delete</a> </button>
                                                        </td>
                                                        </tr>';
                                                    }
                                                }
