...
if (isset($_POST['addachat'])) {
    $reffournisseur = $_POST['reffournisseur'];
    $refproduit = $_POST['refproduit'];
    $quantite = $_POST['quantite'];
    $prix_u = $_POST['prix_u'];
    $date_achat = $_POST['date_achat'];
    $sql = " INSERT INTO `approvisionnement`( `reffournisseur`,`refproduit`,`quantite`,`prix_u`,`date_achat`) VALUES ('$reffournisseur','$refproduit','$quantite','$prix_u','$date_achat')";
                ...
                <div class="container-fluid">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="demoModalLabel">achat add</h5>
                                        ...
                                        <div class="modal-body">
                                            <form method="post">
                                                <div class="mb-3">
                                                    <label for="field-3" class="form-label">fournisseur</label>
                                                    <?php
                                                    $sql = "select * from `fournisseur`";
                                                    $result = mysqli_query($con, $sql);
                                                    $row = mysqli_fetch_assoc($result);
                                                    ?>
                                                    <select name="reffournisseur" id="" class="form-control">
                                                    ...
                                                    <input type="text" name="quantite" class="form-control" id="field-3"
                                                        placeholder=" enter your quantity">
                                                    <label for="field-3" class="form-label">prix_u</label>
                                                    <input type="text" name="prix_u" class="form-control" id="field-3"
                                                        placeholder=" enter your prix_u">
                                                    <label for="field-3" class="form-label">date</label>
                                                    <input type="datetime-local" name="date_achat" class="form-control">

                                                </div>
                                                <button type="submit" class="btn btn-primary"
                                                    name="addachat">Save</button>
                                            </form>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#demoModal">Add achat</button><br>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button  class="btn btn-primary"> <a href="edit-achat.php? updateid=' . $id . '" class="text-light">edit</a> </button>
                                                        <button class="btn btn-danger"name="danger">   <a href="delete-achat.php? deletedid=' . $id . '" class="text-light">delete</a> </button>
                                                        </td>
                                                        </tr>';
                                                    }
                                                }
                    ...
                    <footer class="footer">
                        <div class="w-100 clearfix">
                            <span class="text-center text-sm-left d-md-inline-block">Copyright © 2024 CorneilleMak v2.0.
                                All
