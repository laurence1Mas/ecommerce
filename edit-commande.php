...
include 'config_db/config.php';
    ...
    $refutilisateur=$row['refutilisateur'];
    $dateCom=$row['dateCom'];
    $etatCom=$row['etatCom'];
...
if(isset($_POST['updatecommande'])){
    ...
    $sql=" UPDATE `commande` set `id`='$id',`refutilisateur`='$refutilisateur',`dateCom`='$dateCom',`etatCom`='$etatCom' WHERE  `id`='$id' ";
    $result=mysqli_query($con,$sql);
    if($result){
        echo "data insert";
                                ...
                                <form  method="post">
                                    <div class="mb-3">
                                        ...
                                        <?php
                                                    ...
                                                    $row=mysqli_fetch_assoc($result);
                                                ?>
                                                <select name="refutilisateur" id="" class="form-control">
                                        ...
                                        <label for="field-3" class="form-label">date de la commande</label>
                                        <input type="date" name="dateCom" class="form-control">
                                        <label for="field-3" class="form-label">etat de la commande</label>
                                        <input type="text" name="etatCom" class="form-control" id="field-3">
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="updatecommande">edit</button>
                                </form>
                            </div>
                        </div>
                        </div>
