...
if(isset($_POST['adduser'])){
    ...
    $sql=" INSERT INTO `user`( `name`,`email`,`role`,`password`) VALUES ('$nom','$email','$role','$hashedPassword')";
                    ...
                    <div class="card">
                        ...
                        <div class="modal fade" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <form  method="post">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control" id="field-3" placeholder=" enter your name">
                                                ...
                                                <input type="password" name="password" class="form-control" id="field-3" placeholder=" enter your password">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add user</button><br>
                                    <a href="listeclient.php" class="btn btn-outline-primary me-2"> Download</a>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button  class="btn btn-primary"> <a href="edit-user.php? updateid=' . $id . '" class="text-light">edit</a> </button>
                                                        <button class="btn btn-danger"name="danger">   <a href="delete-user.php? deletedid=' . $id . '" class="text-light">del</a> </button>
                                                        </td>
                                                        </tr>';
                                                    }
                                                }
