...
if (isset($_POST['addCat'])) {
    ...
    $sql = " INSERT INTO `categorieprod`( `nomCat`,`description`) VALUES ('$nomCat','$description')";
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3>espace categorie du produit.</h3>
                        </div>
                        <div class="card-body">
                        <div class="modal fade" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="demoModalLabel">Category of product add</h5>
                                    ...
                                    <div class="modal-body">
                                        <form class="tm-edit-product-form" method="post" enctype="multipart/form-data"  >
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nomCat" class="form-control" id="field-3" placeholder=" entrer nom du produit">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add product</button><br>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <button  class="btn btn-primary"> <a href="edit-catproduct.php? updateid=' . $id . '" class="text-light">edit</a> </button>
                                                        <button class="btn btn-danger"name="danger">   <a href="delete-catproduct.php? deletedid=' . $id . '" class="text-light">delete</a> </button>
                                                        </td>
                                                        </tr>';
                                                    }
                                                }
