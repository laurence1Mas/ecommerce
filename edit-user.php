...
if (isset($_POST['updateuser'])) {
    ...
    $sql = " UPDATE`user` set `id`='$id',`name`='$name',`email`='$email',`role`='$role',`password`='$hashedPassword' WHERE `id`='$id' ";
    $result = mysqli_query($con, $sql);
    if ($result) {
        echo "data insert";
...
<head>
    ...
    <title>Suivi de la commande/livraison</title>
                ...
                <div class="container-fluid">
                                ...
                                <div class="col-md-12">
                                    <form method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="field-3" value=<?php echo $nom; ?>>
                                            ...
                                            <input type="password" name="password" class="form-control" id="field-3"
                                                value="">
                                        </div>
                    ...
                    <footer class="footer">
                        <div class="w-100 clearfix">
                            <span class="text-center text-sm-left d-md-inline-block">Copyright © 2024 coeneille v2.0.
                                All
