...
if(isset($_POST['updateclient'])){
    ...
    $sql=" UPDATE `utilisateur` set `id`='$id',`nom`='$nom',`adresse`='$adresse',`email`='$email',`PASSWORDS`='".md5($PASSWORDS)."',`telephone`='$telephone' WHERE `id`='$id' ";
    $result=mysqli_query($con,$sql);
    if($result){
        echo "data insert";
                            ...
                            <div class="row">
                                ...
                                <form  method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control" id="field-3" value=<?php echo $email; ?>>
                                        <label for="field-3" class="form-label">PASSWORDS</label>
                                        <input type="password" name="PASSWORDS" class="form-control" id="field-3" value="">
