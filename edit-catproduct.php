...
require 'config_db/function.php';
    ...
    $id=$_GET['updateid'];
    $sql="select * from `categorieprod` where id=$id";
...
if(isset($_POST['updatcatproduct'])){
    $nomCat=$_POST['nomCat'];
    $description=$_POST['description'];
    $sql=" UPDATE `categorieprod` set `id`='$id',`nomCat`='$nomCat',`description`='$description' WHERE `id`='$id' ";
    $result=mysqli_query($con,$sql);
    if($result){
        echo "data insert";
        ...
        <header class="header-top" header-theme="blue">
            <div class="container-fluid">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="top-menu d-flex align-items-center">
                        <h4 class="header">Suivi de livraison</h4>
                        <!-- ================================== -->
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <form  method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nomCat" class="form-control" id="field-3" value=<?php echo $nomCat; ?>>
                                    ...
                                    <button type="submit" class="btn btn-primary" name="updatcatproduct">edit</button>
                                </form>
                            </div>
                        </div>
                        </div>
