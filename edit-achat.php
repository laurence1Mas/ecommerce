...
if(isset($_POST['updatachat'])){
    ...
    $sql=" UPDATE `approvisionnement` set `id`='$id',`reffournisseur`='$reffournisseur',`refproduit`='$refproduit',`quantite`='$quantite',`prix_u`='$prix_u',`date_achat`='$date_achat'  WHERE  `id`='$id' ";
    $result=mysqli_query($con,$sql);
    if($result){
        echo "data insert";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form  method="post">
                                    <div class="mb-3">
                                        <label for="field-3" class="form-label">reffournisseur</label>
                                        <?php
                                        ...
                                        <input type="date" name="date_achat" class="form-control" id="field-3" value=<?php echo $date_achat; ?>>
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="updatachat">edit</button>
                                </form>
                            </div>
                        </div>
                        </div>
